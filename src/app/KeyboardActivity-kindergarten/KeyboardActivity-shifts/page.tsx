...
const shiftsKeyPressPage = () => {
    ...
    useEffect(() => {
        const handleKeyDown = async (e: KeyboardEvent) => {
            ...
            if (isCorrect = e.code === "ShiftLeft" || e.code === "ShiftRight") {
                setKeyPressed(e.code);
    ...
    return (
        <main className="flex min-h-screen flex-col justify-between bg-[#FAF9F6] font-serif leading-normal tracking-normal text-[#132241]">            <title>Press any of the shifts Activity</title>
            <Nav />
