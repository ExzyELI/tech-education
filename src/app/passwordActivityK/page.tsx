...
const PasswordPage = () => {
  ...
  const [passwordK_attempts, setAttempts] = useState(0); // store attempts
  ...
  const getRecentActivity = async (userId: string) => {
    ...
    if (!querySnapshot.empty) {
      ...
      setAttempts(activityData.passwordK_attempts);
  ...
  const calculateStrength = (): number => {
    ...
    if (password.match(lowerCaseLetters)) strength += 2; // Each criteria now adds 2 instead of 1
    if (password.match(upperCaseLetters)) strength += 2; // to reach a max of 4 with only 2 criteria
          ...
          <div className="w-full">
            ...
            >
              <div className="flex flex-col">
                ...
                <div
                  id="message"
                  className="mb-4 rounded-lg bg-gray-100 p-4 pb-20"
                >
