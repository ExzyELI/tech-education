...
const KeyAKeyPressPage = () => {
    ...
    return (
        <main className="flex min-h-screen flex-col space-y-[110px] bg-[#ffecde] font-serif leading-normal tracking-normal text-[#132241]">
            <title>Press KeyA Activity</title>
            <Nav />
            <div className="flex flex-col items-center justify-center">
                <h1 className="text-2xl font-bold">Press the KeyA Button</h1>
                {/* image path */}
                ...
                {showMarks && (
                    <p className="mt-4 text-lg">
                        ...
                        {correctPress ? (
                            <span className="text-green-500">✓ Correct! You pressed the KeyA button.</span>
                        ) : (
                            //display any other key pressed */}
                            <span className="text-red-500">✗ You pressed {keyPressed}. Please press the KeyA button.</span>
                        )}
                    </p>
                )}
