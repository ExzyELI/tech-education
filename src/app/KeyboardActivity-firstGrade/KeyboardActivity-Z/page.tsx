  ...
  useEffect(() => {
    const fetchAndSumScores = async () => {
      ...
      const totalScore = snapshot.docs
        .filter(doc => doc.data().activityName === "KeyboardActivity-firstGrade")
          ...
          <p className="mt-4 text-lg">
            ...
            {correctPress ? (
              ...
              <span className="text-red-500">
                ✗ You pressed {keyPressed}. Please Press the Key Z button.
              </span>
            )}
          </p>
        )}
