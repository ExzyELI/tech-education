...
const PasswordPage = () => {
  ...
  const [password2_attempts, setAttempts] = useState(0); // store attempts
  ...
  const getRecentActivity = async (userId: string) => {
    ...
    if (!querySnapshot.empty) {
      ...
      setAttempts(activityData.password2_attempts);
