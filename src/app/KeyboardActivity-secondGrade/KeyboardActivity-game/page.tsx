...
const WordInputPage = () => {
    const targetWord = "game"; //word to match
    ...
    useEffect(() => {
     ...
     // path to next task
     const goToNextTask = () => {
        router.push("/KeyboardActivity-secondGrade/KeyboardActivity-hat");
    };
    ...
    return (
        <main className="flex min-h-screen flex-col space-y-[110px] bg-[#ffecde] font-serif leading-normal tracking-normal text-[#132241]">
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                {/* image path */}
                <img src="/images/game-key-press.gif" alt="Type Word" className="mt-4" />
                {showMarks && (
