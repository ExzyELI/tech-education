...
const WordInputPage = () => {
    const targetWord = "tree"; //word to match
    ...
    // path to next task
    const goToNextTask = () => {
        router.push("/KeyboardActivity-secondGrade/KeyboardActivity-up");
    };
    ...
    return (
        <main className="flex min-h-screen flex-col space-y-[110px] bg-[#FAF9F6] font-serif leading-normal tracking-normal text-[#132241]">
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                {/* image path */}
                <img src="/images/tree-key-press.gif" alt="Type Word" className="mt-4" />
                {showMarks && (
