...
const WordInputPage = () => {
    const targetWord = "up"; //word to match
    ...
    // path to next task
    const goToNextTask = () => {
        router.push("/KeyboardActivity-secondGrade/KeyboardActivity-vest");
    };
    ...
    return (
        <main className="flex min-h-screen flex-col space-y-[110px] bg-[#ffecde] font-serif leading-normal tracking-normal text-[#132241]">
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                {/* image path */}
                <img src="/images/up-key-press.gif" alt="Type Word" className="mt-4" />
                {showMarks && (
