...
const WordInputPage = () => {
    const targetWord = "ice"; //word to match
    ...
    // path to next task
    const goToNextTask = () => {
        router.push("/KeyboardActivity-secondGrade/KeyboardActivity-jump");
    };
    ...
    return (
        <main className="flex min-h-screen flex-col justify-between bg-[#FAF9F6] font-serif leading-normal tracking-normal text-[#132241]">
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                {/* image path */}
                <img src="/images/ice-key-press.gif" alt="Type Word" className="mt-4" />
                {showMarks && (
