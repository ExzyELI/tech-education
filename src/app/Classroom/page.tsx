...
export default function Home() {
  ...
  const handleRemoveStudent = (indexToRemove: number) => {
    const updatedStudents = students.filter(
      (student, index) => index !== indexToRemove,
    );
              ...
              <div className="col-span-1 row-span-1 rounded-md border border-gray-200 bg-white">
                ...
                <table className="flex table-auto flex-col items-center justify-center">
                  <tbody>
                    ...
                    <tr
                      className="cursor-pointer hover:text-[#ff6865]"
                      onClick={handleChangeTeacherName}
                    >
                      {/* create a pin option so students can join classroom */}
                      <td>Edit Name</td>
                    </tr>
                    ...
                    {showSettings && (
                      <div className="absolute mt-2 w-48 rounded-lg bg-white shadow-lg">
                        <button className="block w-full px-4 py-2 text-gray-800 hover:bg-gray-200">
                          Change Pin
                        </button>
                        <button className="block w-full px-4 py-2 font-bold text-red-500 hover:bg-gray-200">
                          Delete Classroom
                        </button>
                      </div>
                    )}
